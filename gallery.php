...
<section class="portfolio section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="filtering text-center col-12">
                <div class="filter box">
                    ...
                    <span data-filter='.kit'>Kitchen</span>
                    <span data-filter='.ward'>Wardrobes</span>
                    <span data-filter='.croc'>Crockery</span>
                    <span data-filter='.tv'>TV Unit</span>
                    <span data-filter='.office'>Office</span>
                    <span data-filter='.parti'>Partitions</span>
                    <span data-filter='.other'>Other</span>
                </div>
            </div>
        </div>
        ...
        <div class="row gallery twsty inf-lit full-width">
            ...
            <!-- gallery item -->
            <div class="col-lg-4 col-md-6 col-sm-6 items kit  mt-25">
