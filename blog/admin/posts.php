...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $edit_sql = mysqli_query($connect, "UPDATE posts SET title='$title',url='$url', image='$image', active='$active', featured='$featured', date='$date', time='$time', category_id='$category_id', content='$content',tags='$tags' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0;url=posts.php">';
    }
?>
    <style>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <p>
                    <label>Url</label>
                    <input class="form-control" class="form-control" name="url" type="text" value="<?php
                                                                                                    echo $row['url'];
                                                                                                    ?>" required>
                </p>
                <p>
                ...
                <div class="col-xs-8">
                    <input type="text" id="tags" name="tags" data-role="tagsinput" class="form-control" value="<?php
                                                                                                                echo $row['tags'];
                                                                                                                ?>" required />
                </div>
                </p>
