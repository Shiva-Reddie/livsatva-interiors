                ...
                <div class="htit">
                    ...
                    <div class="text">
                        <p>Our modular crockery solutions are thoughtfully designed to keep your dining and kitchen
                            essentials well-organized while enhancing the beauty of your interiors. From compact wall
                            units to spacious crockery cabinets, we bring functionality blended with style.</p>

                        <div class="row mt-4">
                            <div class="col-12 mb-2">
                                <i class="fas fa-layer-group"></i> Smart layouts for plates, bowls, glasses & cutlery
                            </div>
                            <div class="col-12 mb-2">
                                <i class="fas fa-door-open"></i> Sleek shutters, glass doors & open shelving options
                            </div>
                            <div class="col-12 mb-2">
                                <i class="fas fa-seedling"></i> Durable finishes with modern designs that match your
                                décor
                            </div>
                        </div>
...
<section class="faq-section py-5 bg-light">
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Find quick answers to common questions about our modular crockery units.</p>
        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq1" class="accordion-collapse collapse" aria-labelledby="faq1-heading"
                            ...
                            <div class="accordion-body">
                                A modular crockery unit is a customizable storage solution designed to organize and
                                showcase your crockery, glassware, and dining essentials in a stylish and efficient way.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq2-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What materials are used for crockery units?
                            </button>
                        </h2>
                        <div id="faq2" class="accordion-collapse collapse" aria-labelledby="faq2-heading"
                            data-bs-parent="#faqLeft">
                            <div class="accordion-body">
                                We use premium materials such as engineered wood, plywood, glass, laminates, and
                                high-quality hardware to ensure durability and a modern finish.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq3-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can the crockery unit be customized?
                            </button>
                        </h2>
                        <div id="faq3" class="accordion-collapse collapse" aria-labelledby="faq3-heading"
                            data-bs-parent="#faqLeft">
                            <div class="accordion-body">
                                Yes! You can customize the design, size, layout, shelves, drawers, finishes, and
                                lighting
                                options to perfectly suit your dining or kitchen space.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq4-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Do modular crockery units include lighting?
                            </button>
                        </h2>
                        <div id="faq4" class="accordion-collapse collapse" aria-labelledby="faq4-heading"
                            data-bs-parent="#faqRight">
                            <div class="accordion-body">
                                Yes, you can add LED lighting or spotlights to enhance the display of your crockery and
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq5-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How do I maintain a crockery unit?
                            </button>
                        </h2>
                        <div id="faq5" class="accordion-collapse collapse" aria-labelledby="faq5-heading"
                            data-bs-parent="#faqRight">
                            <div class="accordion-body">
                                Maintenance is simple—wipe with a soft cloth, avoid water spillage on wooden surfaces,
                                and use mild cleaners for glass sections.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq6-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can crockery units be wall-mounted or free-standing?
                            </button>
                        </h2>
                        <div id="faq6" class="accordion-collapse collapse" aria-labelledby="faq6-heading"
                            data-bs-parent="#faqRight">
                            <div class="accordion-body">
                                Yes, modular crockery units are available in both wall-mounted and free-standing
                                options, depending on your space and style preference.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="content text-center">
                    <a href="./office.php">
                        ...
                        <h2 class="wow" data-splitting=""><b> Modular </b> Office</h2>
                    </a>
                </div>
            </div>
        </div>
