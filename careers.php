    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="job-card">
          ...
          <p class="mt-2">We’re looking for a creative frontend developer with strong React & UI/UX skills.</p>
          ...
          <button class="btn btn-apply mt-3 " data-bs-toggle="modal" data-bs-target="#applyModal">Apply Now</button>
        </div>
      </div>
...
<div class="col-md-6">
  <div class="job-card p-4">
    ...
    <p class="mt-2">Join our creative studio team to design sophisticated interior spaces for global clients.</p>
    ...
    <ul class="list-unstyled text-muted mb-3">
      ...
      <li><i class="fa-solid fa-graduation-cap me-2"></i> Qualification: B.Des / M.Des / Equivalent</li>
      <li><i class="fa-solid fa-swatchbook me-2"></i> Skills: AutoCAD, SketchUp, 3Ds Max, Creativity</li>
    </ul>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="applyForm">
            ...
            <button type="submit" class="submit-btn"><i class="fa-solid fa-check me-2"></i>Submit Application</button>
          </form>
        </div>
