                ...
                <div class="posts row">
                        ...
                        <div class="item  mb-30">
                            <div class="img">
                                ...
                                <div class="info">
                                    <div class="date">
                                        <h5>
                                            <a href="#0">
                                                <span class="num custom-font">15</span>
                                                <span>Sep</span>
                                            </a>
                                        </h5>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="content">
                                        <div class="tags">
                                            <a href="#0">Interiors</a>
                                            <a href="#0">Kitchen Interiors</a>
                                            <a href="#0">Wardrobes</a>
                                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="item">
                            <div class="img">
                                <a href="blog-details.html">
                                    <img src="assets/img/blog/b4.jpg" alt="" class="thumparallax">
                                </a>
                                <div class="info">
                                    <div class="date">
                                        <h5>
